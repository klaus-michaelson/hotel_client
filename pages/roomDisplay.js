...
import { Image, InputNumber, Checkbox, Dropdown, Menu, Input, Button, Space, DatePicker, Collapse, Slider } from "antd";
import { CalendarOutlined, DownOutlined, UsergroupAddOutlined } from '@ant-design/icons';
...
export class GuestBookInfo extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={'mrg-ver ' + styles.gBookInfo} style={{marginTop: "100px"}}>
        <div>
            ...
            this.state.list.map((room) => (
              <div key={room.id} className={"w-md test " + styles.roomDisp}>
                ...
                <div className={styles.descr}>
                  ...
                  <div className="row">
                    <Button style={{ flex: 1 }} type="primary">BOOK NOW</Button>
                  </div>
                </div>
              </div>
            )
