  ...
  >
    <Space direction='vertical' size="large" style={{width:"100%"}}>
      <Space direction='vertical' style={{width:"100%"}}>
        Phone Number *
        <Input placeholder="Phone Number" onChange={({target})=>setPhoneNumber(target.value)}></Input>
        {errorPhone(phoneNumber)}
      </Space>
      <Space direction='vertical' style={{width:"100%"}}>
        Email
        <Input placeholder="Email" type='email' onChange={({target})=>setEmail(target.value)}></Input>
        {errorEmail(email)}
      </Space>
      <Space direction='vertical' style={{width:"100%"}}>
        Password *
        <Input placeholder="Password" type="password" onChange={({target})=>setPassword(target.value)}></Input>
        {errorPass(password)}
      </Space>
      <Space direction='vertical' style={{width:"100%"}}>
        <Row>
      ...
      <Space direction='vertical' style={{width:"100%"}}>
        <div style={{textAlign:'center',width:'100%'}}>
          <Link style={{width:'100%'}} href="/login">Already have an account? Login</Link>
        </div>
      </Space>
    </Space>
  </Card>
