    ...
    >
        <Space direction='vertical' size="large" style={{width:"100%"}}>
            <Space direction='vertical' style={{width:"100%"}}>
                Password
                <Input placeholder="Password" type="password" value={password} onChange={({target})=>{setPassword(target.value)}}></Input>
                {errorPass(password)}
            </Space>
            <Space direction='vertical' style={{width:"100%"}}>
                Confirm - Password
                <Input placeholder="Password" type="password" value={coPassword} onChange={({target})=>{setCoPassword(target.value)}}></Input>
