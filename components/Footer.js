    ...
    <Row className={styles.main}>
      <Col xs={{ offset: 1, span: 22 }} sm={{ offset: 2, span: 20 }}>
        <Row gutter={{ xs: 0, sm: 16, md: 24, lg: 32 }}>
          <Col className="gutter-row pt-2 pt-4" xs={24} sm={12} md={6}>
            <Row className="mb-3">
            ...
            <div>
              Triangle Incorporated Hotel is a brand new hotel having a unique
              and surprising service culture located at the heart of Hawassa,
              Ethiopia with a very close proximity to Hawassa International
              stadium, Hawassa National Airport, and walking distance from SNNP
              President Office and Hawassa University.
            </div>
          </Col>
